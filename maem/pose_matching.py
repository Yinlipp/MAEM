...
# 2D points here are assumed already undistorted by Stage 1; don't re-undistort.
                ...
                for p2_idx in range(num_p2):
                    ...
                    if matching_mode in ('epi_gate', 'repr_gate', 'epi_gate_only'):
                        ...
                        if matching_mode in ('epi_gate', 'epi_gate_only'):
                            mesh_2 = poses2[p2_idx].get('pred_keypoints_2d_verts')
