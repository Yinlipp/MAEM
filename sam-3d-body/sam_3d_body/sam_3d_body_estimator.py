...
class SAM3DBodyEstimator:
    ...
    def process_one_image(
        ...
        if bboxes is not None:
            ...
            bbox_scores = np.ones(len(boxes), dtype=np.float32)  # Default score for provided bboxes
            self.is_crop = True
            ...
            all_out.append(
                {
                    ...
                    "bbox_score": bbox_scores[idx],
                    "focal_length": out["focal_length"][idx],
                    "pred_keypoints_3d": out["pred_keypoints_3d"][idx],
                    "pred_keypoints_2d_verts": out["pred_keypoints_2d_verts"][idx],
